          ...
          >
            ...
            >
              <div className="flex-1">
                <h3 className="font-semibold text-popover-foreground/90 text-base mb-1">
                  {chapter.title}
                </h3>
                <p className="text-sm text-popover-foreground/40">
                  {chapter.lectures.length} Videos •{" "}
                  {durationFormatterString(moduleDuration)}
                </p>
              </div>
                ...
                {chapter.lectures.map((lesson: Lecture) => (
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-500 flex-shrink-0">
                      {durationFormatterString(lesson.duration)}
                    </span>
                  </div>
                ))}
              </div>
