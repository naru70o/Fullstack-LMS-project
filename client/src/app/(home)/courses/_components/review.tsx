  ...
  return (
    <div className="flex flex-col gap-4 p-4 rounded-xl bg-popover border border-popover-foreground/30 max-w-2xl">
      ...
      <p className="text-sm text-popover-foreground/80 mt-1">
        This course was fantastic! The instructor was clear, concise, and the
        projects were very helpful for applying the concepts. I feel much more
        confident in my skills now. Highly recommended!
      </p>
    </div>
  );
};
