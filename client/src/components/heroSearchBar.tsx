...
export const HeroSearchBar = () => {
  return (
    <div className='absolute container mx-auto flex flex-col gap-4 p-8 justify-center bottom-0 translate-y-1/2 bg-white rounded-3xl shadow-[var(--shadow-search-bar)] max-w-5xl'>
        <h1 className='text-black font-poppins text-xl not-italic font-bold leading-[30px]'>What do you want to learn?</h1>
        ...
        />
        <SelectInput selectItems={['Apple', 'Banana', 'Blueberry', 'Grapes', 'Pineapple']} selectLabel="Categories" selectPlaceholder="Select a Category" />
